        ...
        <div className="item-card" style={{ display: 'flex' }}>
            ...
            <Card style={{ maxWidth: '15rem', margin: '2vh', marginLeft: '5px', minWidth: '15rem' }}>
                <Card.Body>
                    ...
                    <Card.Text className="requirements">{item !== null && item.preview_item.requirements.skill !== undefined ? item.preview_item.requirements.skill.display_string : null}</Card.Text>
                    <Card.Text className="requirements">{item !== null && item.preview_item.requirements.reputation !== undefined ? item.preview_item.requirements.reputation.display_string : null}</Card.Text>
                    <Card.Text className="useEffect">{item !== null && item.preview_item !== undefined ? 'Use: ' + item.preview_item.description : null}</Card.Text>
